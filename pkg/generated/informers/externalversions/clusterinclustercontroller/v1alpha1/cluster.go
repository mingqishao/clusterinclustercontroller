...
import (
	...
	clusterinclustercontrollerv1alpha1 "github.com/mingqishao/clusterinclustercontroller/pkg/apis/clusterinclustercontroller/v1alpha1"
	...
	v1alpha1 "github.com/mingqishao/clusterinclustercontroller/pkg/generated/listers/clusterinclustercontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ClusterinclustercontrollerV1alpha1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClusterinclustercontrollerV1alpha1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&clusterinclustercontrollerv1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterinclustercontrollerv1alpha1.Cluster{}, f.defaultInformer)
}
