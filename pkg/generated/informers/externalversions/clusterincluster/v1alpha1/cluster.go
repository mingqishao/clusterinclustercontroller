...
import (
	...
	clusterinclusterv1alpha1 "github.com/mingqishao/clusterinclustercontroller/pkg/apis/clusterincluster/v1alpha1"
	...
	v1alpha1 "github.com/mingqishao/clusterinclustercontroller/pkg/generated/listers/clusterincluster/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecontrollerV1alpha1().Clusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecontrollerV1alpha1().Clusters(namespace).Watch(context.TODO(), options)
			},
		},
		&clusterinclusterv1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterinclusterv1alpha1.Cluster{}, f.defaultInformer)
}
