...
type FakeClusters struct {
	Fake *FakeClusterinclustercontrollerV1alpha1
	ns   string
}

var clustersResource = schema.GroupVersionResource{Group: "clusterinclustercontroller.k8s.io", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "clusterinclustercontroller.k8s.io", Version: "v1alpha1", Kind: "Cluster"}
