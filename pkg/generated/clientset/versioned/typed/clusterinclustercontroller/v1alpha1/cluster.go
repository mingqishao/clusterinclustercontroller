...
import (
	...
	scheme "github.com/mingqishao/clusterinclustercontroller/pkg/generated/clientset/versioned/scheme"
...
func newClusters(c *ClusterinclustercontrollerV1alpha1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
